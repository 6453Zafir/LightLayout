...
public class BakerWithIsm : MonoBehaviour
{
    private VplWithIsm _gi;
   ...
   // public bool SaveLightmapBeforePostprocessing;
    ...
    public enum ISMGenType
    {
        TS,
        CS
    }

    public ISMGenType ISMType;
    private UnityLmGBuffer _geometryBuffer;

    private List<Light> _bakedLights;

    public static BakerWithIsm Instance => _instance;
    
    void Awake()
    {
        _instance = this;
    }
    private static BakerWithIsm _instance =null;

    public bool ClusterStage;
    public bool LightmapStage;
    ...
    public void SaveLightmapBeforePostprocessing()
    {
        ...
        if (ShowPolygonLight)
        {
            ...
            foreach (var b in _gi.PolygonLightBounces)
            {
                foreach (var p in b)
                {
                    ...
                    Gizmos.DrawLine(p.Center, p.Center  +  1 * p.Normal);
                }
            }
        }
